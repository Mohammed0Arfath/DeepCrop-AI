...
def split_aug_data(base_dir):
    image_dir = Path(f"Crop_Diseases/images/aug")
    label_dir = Path(f"Crop_Diseases/labels/aug")

    out_img_train = Path(f"Crop_Diseases_Aug/images/train")
    out_img_val = Path(f"Crop_Diseases_Aug/images/val")
    out_lbl_train = Path(f"Crop_Diseases_Aug/labels/train")
    out_lbl_val = Path(f"Crop_Diseases_Aug/labels/val")
...
# Run this:
split_aug_data("C:/Users/moham/Agrithon/Crop_Diseases")
